...
<div class="space-y-8" x-data="{ search: '' }">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-lg text-gray-400">Gerencie todos os alunos vinculados ao seu perfil.</p>
        </div>
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <span class="text-sm text-gray-400">{{ $students->count() }} cadastrados</span>
    </div>
