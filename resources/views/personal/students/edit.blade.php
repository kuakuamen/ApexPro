...
<div class="max-w-4xl mx-auto space-y-8">
    <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl shadow-lg overflow-hidden">
        ...
        @endphp
        <div class="p-6">
            <form action="{{ route('personal.students.update', $student) }}" method="POST" id="student-edit-form">
                @csrf
                @method('PUT')
                ...
                <div id="tab-panel-dados" class="{{ $activeTab === 'dados' ? '' : 'hidden' }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-4">
                            @php
                                $birthDateIso     = old('birth_date', $student->birth_date ? $student->birth_date->format('Y-m-d') : '');
                                $birthDateDisplay = '';
                ...
                <div id="tab-panel-endereco" class="{{ $activeTab === 'endereco' ? '' : 'hidden' }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="text" name="address_cep" id="address_cep" value="{{ old('address_cep', $student->address_cep) }}" inputmode="numeric" autocomplete="postal-code" placeholder="00000-000" class="block w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 pr-10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" required pattern="\d{5}-\d{3}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="address_city" id="address_city" value="{{ old('address_city', $student->address_city) }}" autocomplete="address-level2" placeholder="Cidade" class="block w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="address_neighborhood" id="address_neighborhood" value="{{ old('address_neighborhood', $student->address_neighborhood) }}" autocomplete="address-level3" placeholder="Bairro" class="block w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4 md:col-span-2">
                            ...
                            <input type="text" name="address_street" id="address_street" value="{{ old('address_street', $student->address_street) }}" autocomplete="address-line1" placeholder="Rua" class="block w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" required>
