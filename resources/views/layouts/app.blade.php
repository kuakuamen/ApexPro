            ...
            <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
                ...
                @if(auth()->check())
                    ...
                    @if(auth()->user()->role === 'personal')
                        <a href="{{ route('personal.students.index') }}" class="group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('personal.students.index') || request()->routeIs('personal.students.show') ? 'bg-teal-900/40 text-stone-100 border-l-4 border-teal-400' : 'text-stone-300 hover:bg-teal-950/50 hover:text-stone-100' }}">
                            <svg class="w-5 h-5 mr-3 {{ request()->routeIs('personal.students.index') || request()->routeIs('personal.students.show') ? 'text-teal-300' : 'text-stone-500 group-hover:text-teal-300' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                            Alunos
                        </a>
