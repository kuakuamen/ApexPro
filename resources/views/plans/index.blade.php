...
<nav>
  ...
  <a href="{{ route('login.entry') }}" class="nav-cta">LOGIN</a>
</nav>
        ...
        <div class="pricing-card {{ $isFeatured ? 'featured' : '' }} fade-up">
          ...
          <div class="plan-desc">
            @if($planId === 'plan_elite')
              Para gerenciar <strong style="color: white;">alunos ilimitados</strong> de consultoria.
            @else
  ...
  <div style="max-width: 760px; margin: 0 auto; position: relative; z-index: 1;">
    <div style="background: linear-gradient(135deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.01) 100%); border: 1px solid rgba(37,211,102,0.25); border-radius: 28px; padding: 56px 48px; text-align: center; box-shadow: 0 0 60px rgba(37,211,102,0.07);">
      ...
      <h2 style="font-size: clamp(1.6rem, 4vw, 2.4rem); font-weight: 800; color: #fff; margin-bottom: 16px; line-height: 1.25;">
        ...
        <span style="color: #25d366;">50% de desconto</span> com acesso vitalicio
      </h2>
      ...
      <p style="color: rgba(255,255,255,0.5); font-size: 1.05rem; margin-bottom: 32px; max-width: 520px; margin-left: auto; margin-right: auto; line-height: 1.7;">
        Quem entrar agora na nossa comunidade garante acesso antecipado com <strong style="color: rgba(255,255,255,0.85);">metade do preço com acesso vitalicio.</strong>
      </p>
      ...
      <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; margin-bottom: 36px;">
        ...
        <span style="display: flex; align-items: center; gap: 6px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.08); color: rgba(255,255,255,0.7); font-size: 13px; padding: 8px 16px; border-radius: 100px;">✅ 50% de desconto com acesso vitalicio</span>
      ...
      <p style="color: rgba(255,255,255,0.25); font-size: 13px; margin-top: 18px;">Grátis para entrar. Desconto vitalicio garantido para quem entrar agora.</p>
    </div>
  </div>
</section>
