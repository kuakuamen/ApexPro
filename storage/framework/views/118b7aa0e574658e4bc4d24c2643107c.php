    ...
    <div id="tab-images" class="tab-content">
        <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl shadow-lg overflow-hidden">
            <div class="p-6">
                ...
                <form action="<?php echo e(route('personal.ai-assessment.analyze')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select id="student_id" name="student_id" class="block w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" required>
                                ...
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($student->id); ?>" class="bg-gray-700"><?php echo e($student->name); ?></option>
    ...
    <div id="tab-noimage" class="tab-content hidden">
        <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl shadow-lg overflow-hidden">
            <div class="p-6">
                ...
                <form action="<?php echo e(route('personal.ai-assessment.analyze-no-images')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
    ...
    <div class="bg-gray-800/50 backdrop-blur-sm border-t border-gray-700 px-6 py-4">
        <div class="flex justify-between items-center">
            <div class="text-sm text-gray-400">
                <p>© <?php echo e(date('Y')); ?> FitManager - Todos os direitos reservados</p>
            </div>
            <div class="text-sm text-gray-400">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fitmanager\resources\views/personal/ai-assessment/index.blade.php ENDPATH**/ ?>