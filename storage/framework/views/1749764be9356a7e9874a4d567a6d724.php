...
<div class="space-y-6" x-data="{ 
    days: <?php echo e(json_encode($analysisResult['workout_recommendation']['days'] ?? [])); ?>,
    addDay() {
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="<?php echo e(route('personal.ai-assessment.index')); ?>" class="text-gray-500 hover:text-gray-700">
            &larr; Voltar
        </a>
    </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden border-l-4 border-indigo-500">
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-red-50 p-4 rounded-md">
                    ...
                    <ul class="list-disc list-inside text-sm text-red-700 space-y-1">
                        <li><strong>Lordose:</strong> <?php echo e($analysisResult['posture_analysis']['lordosis'] ?? 'Não detectado'); ?></li>
                        <li><strong>Escoliose:</strong> <?php echo e($analysisResult['posture_analysis']['scoliosis'] ?? 'Não detectado'); ?></li>
                        <li><strong>Ombros:</strong> <?php echo e($analysisResult['posture_analysis']['shoulders'] ?? 'Neutro'); ?></li>
                        <li><strong>Cabeça:</strong> <?php echo e($analysisResult['posture_analysis']['head_position'] ?? 'Neutro'); ?></li>
                        <li><strong>Joelhos:</strong> <?php echo e($analysisResult['posture_analysis']['knees'] ?? 'Neutro'); ?></li>
                    </ul>
                </div>
                ...
                <div class="bg-green-50 p-4 rounded-md">
                    ...
                    <div class="mb-2">
                        ...
                        <p class="text-sm text-green-800"><?php echo e(implode(', ', $analysisResult['suggested_focus']['strengthen'] ?? [])); ?></p>
                    </div>
                    <div>
                        <span class="text-xs font-bold uppercase text-blue-600">Alongar:</span>
                        <p class="text-sm text-blue-800"><?php echo e(implode(', ', $analysisResult['suggested_focus']['stretch'] ?? [])); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 border-t border-gray-200 pt-4">
                ...
                <form action="<?php echo e(route('personal.ai-assessment.refine')); ?>" method="POST" class="flex gap-2">
                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-4 text-sm text-gray-500">
                <strong>Prioridade do Treino:</strong> <?php echo e($analysisResult['workout_recommendation']['priority'] ?? 'Geral'); ?>
    ...
    <form action="<?php echo e(route('personal.ai-assessment.store')); ?>" method="POST" id="workoutForm">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="student_id" value="<?php echo e($student->id); ?>">
        <input type="hidden" name="goal" value="<?php echo e($request->goal); ?>">
            ...
            <div class="p-6 border-b border-gray-200 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                    <div class="w-64">
                        ...
                        <input type="text" name="workout_name" value="Treino IA: <?php echo e($analysisResult['workout_recommendation']['type'] ?? $request->goal); ?>" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    </div>
                    <!-- Botão Gerar PDF -->
...
<script>
    function generatePDF() {
        ...
        form.action = "<?php echo e(route('personal.ai-assessment.pdf')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fitmanager\resources\views/personal/ai-assessment/review.blade.php ENDPATH**/ ?>