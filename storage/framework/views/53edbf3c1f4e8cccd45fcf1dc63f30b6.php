    ...
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="flex justify-center mb-8">
                <div class="relative w-48 h-48 flex items-center justify-center">
                    ...
                    <img src="<?php echo e(asset('storage/photos/Gemini_Generated_Image_.png')); ?>" alt="ApexPro Logo" class="relative w-28 h-28 rounded-full shadow-2xl object-cover border-4 border-gray-800">
                </div>
            </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-gray-800 bg-opacity-50 backdrop-blur-xl border border-gray-700 py-10 px-6 shadow-2xl sm:rounded-2xl sm:px-12">
                <form class="space-y-8" action="<?php echo e(route('login')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-8 text-center">
                <p class="text-xs text-gray-500">
                    &copy; <?php echo e(date('Y')); ?> ApexPro. Todos os direitos reservados.
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\fitmanager\resources\views/auth/login.blade.php ENDPATH**/ ?>