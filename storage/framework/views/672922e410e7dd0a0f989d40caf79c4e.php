...
<div class="space-y-8" x-data="{ search: '' }">
    ...
    <div>
        <h1 class="text-3xl font-bold text-white">Olá, <?php echo e(auth()->user()->name); ?>!</h1>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-3xl font-bold text-white"><?php echo e($students->count()); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-3xl font-bold text-green-400"><?php echo e($students->where('is_active', true)->count()); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-3xl font-bold text-blue-400"><?php echo e($students->where('created_at', '>=', now()->startOfMonth())->count()); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-3xl font-bold text-yellow-400"><?php echo e($students->filter(fn($s) => $s->measurements->isNotEmpty() && $s->measurements->first()->date->diffInDays(now()) > 30)->count()); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div x-show="search === '' || '<?php echo e(strtolower($student->name)); ?>'.includes(search.toLowerCase())" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                <div class="relative bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl shadow-md hover:shadow-indigo-500/20 hover:border-indigo-500 transition-all duration-300 group p-5 flex flex-col h-full">
                    ...
                    <!-- Status Indicator -->
<span title="<?php echo e($student->is_active ? 'Ativo' : 'Inativo'); ?>" class="absolute top-4 right-4 h-3 w-3 rounded-full <?php echo e($student->is_active ? 'bg-green-500' : 'bg-red-500'); ?> border-2 border-gray-800"></span>
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <div class="ml-4 truncate">
                            <p class="text-lg font-bold text-white truncate group-hover:text-indigo-400 transition-colors"><?php echo e($student->name); ?></p>
                            <p class="text-sm text-gray-400"><?php echo e($student->email ?? 'Sem email'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex-grow space-y-2 text-sm">
                        <div class="flex items-center text-gray-400">
                            ...
                            <?php if($student->measurements->isNotEmpty()): ?>
                                <span class="<?php echo e($student->measurements->first()->date->diffInDays(now()) > 30 ? 'text-yellow-400 font-semibold' : ''); ?>">
                                    Última avaliação: <?php echo e($student->measurements->first()->date->format('d/m/Y')); ?>
                    ...
                    <div class="mt-5 pt-4 border-t border-gray-700 flex items-center justify-between">
                        <a href="<?php echo e(route('personal.students.show', $student)); ?>" class="text-sm font-medium text-indigo-400 hover:text-indigo-300 transition-colors">
                            Ver Perfil Completo
                        </a>
                        <?php if($student->phone): ?>
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $student->phone)); ?>" target="_blank" class="text-green-400 hover:text-green-300 p-2 rounded-full hover:bg-gray-700 transition-colors" title="Chamar no WhatsApp">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full bg-gray-800/50 border border-dashed border-gray-700 rounded-xl text-center p-12">
                ...
                <div class="mt-6">
                    <a href="<?php echo e(route('personal.students.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fitmanager\resources\views/personal/dashboard.blade.php ENDPATH**/ ?>