...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> - ApexPro</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <img src="<?php echo e(asset('storage/photos/Gemini_Generated_Image_.png')); ?>" alt="ApexPro">
            <span>ApexPro</span>
        </div>

        <ul class="sidebar-menu">
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-menu-link <?php echo e(request()->route()->getName() === 'admin.dashboard' ? 'active' : ''); ?>">
                    <i class="fas fa-chart-line"></i> Dashboard
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.personals.index')); ?>" class="sidebar-menu-link <?php echo e(str_starts_with(request()->route()->getName(), 'admin.personals') ? 'active' : ''); ?>">
                    <i class="fas fa-dumbbell"></i> Personals
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-menu-link <?php echo e(str_starts_with(request()->route()->getName(), 'admin.users') ? 'active' : ''); ?>">
                    <i class="fas fa-users"></i> Usuários
                </a>
            </li>
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.logs')); ?>" class="sidebar-menu-link <?php echo e(request()->route()->getName() === 'admin.logs' ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\fitmanager\resources\views/admin/layout.blade.php ENDPATH**/ ?>