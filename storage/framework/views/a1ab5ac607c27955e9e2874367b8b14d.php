...
<div class="space-y-6">
    ...
    <div class="bg-zinc-900/55 shadow rounded-lg p-6 border border-teal-900/30">
        <h2 class="text-2xl font-bold text-stone-100">Olá, <?php echo e(auth()->user()->name); ?>! 👋</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-zinc-900/55 shadow rounded-lg overflow-hidden border-l-4 border-teal-600">
            <div class="px-4 py-5 sm:p-6">
                ...
                <?php if($activeWorkout): ?>
                    <div class="mt-4">
                        <p class="text-xl font-bold text-stone-100"><?php echo e($activeWorkout->name); ?></p>
                        <p class="text-sm text-stone-300 mb-4"><?php echo e($activeWorkout->goal); ?></p>
                        
                        <a href="<?php echo e(route('workouts.show', $activeWorkout)); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-stone-100 bg-teal-700 hover:bg-teal-800 focus:outline-none">
                            Ver Treino Completo
                        </a>
                    </div>
                <?php else: ?>
        ...
        <div class="bg-zinc-900/55 shadow rounded-lg overflow-hidden border-l-4 border-teal-600">
            <div class="px-4 py-5 sm:p-6">
                ...
                <?php if($activeDiet): ?>
                    <div class="mt-4">
                        <p class="text-xl font-bold text-stone-100"><?php echo e($activeDiet->name); ?></p>
                        <p class="text-sm text-stone-300 mb-4"><?php echo e($activeDiet->goal); ?></p>
                        
                        <a href="<?php echo e(route('diets.show', $activeDiet)); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-stone-100 bg-teal-700 hover:bg-teal-800 focus:outline-none">
                            Ver Dieta Completa
                        </a>
                    </div>
                <?php else: ?>
    ...
    <!-- Peso Atual e IMC -->
    <?php if($weightHistory->isNotEmpty()): ?>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Peso -->
        <div class="bg-zinc-900/55 shadow rounded-lg overflow-hidden border-l-4 border-teal-600 p-6 flex items-center justify-between">
            ...
            <div class="text-right">
                <span class="text-4xl font-bold text-stone-100"><?php echo e($weightHistory->last()->weight); ?></span>
        ...
        <div class="bg-zinc-900/55 shadow rounded-lg overflow-hidden border-l-4 border-teal-600 p-6 flex items-center justify-between">
            <div>
                ...
                ?>
                <p class="text-sm text-stone-300 mt-1"><?php echo e($status); ?></p>
            </div>
            <div class="text-right">
                <span class="text-4xl font-bold text-stone-100"><?php echo e($imc > 0 ? number_format($imc, 1) : '-'); ?></span>
            </div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <?php if($weightHistory->isNotEmpty()): ?>
    <?php $lastMeasurement = $weightHistory->last(); ?>
    <div class="bg-zinc-900/55 shadow rounded-lg p-6 border border-teal-900/30 space-y-6">
        <h3 class="text-xl font-bold text-stone-100 border-b border-teal-900/40 pb-3">📋 Detalhes da Última Avaliação (<?php echo e(\Carbon\Carbon::parse($lastMeasurement->date)->format('d/m/Y')); ?>)</h3>
        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm bg-gray-900/60 p-3 rounded-lg border border-gray-700">
                <div><p class="text-gray-400">Peso</p><p class="font-semibold text-white"><?php echo e($lastMeasurement->weight ? $lastMeasurement->weight . ' kg' : '-'); ?></p></div>
                <div><p class="text-gray-400">Altura</p><p class="font-semibold text-white"><?php echo e($lastMeasurement->height ? $lastMeasurement->height . ' m' : '-'); ?></p></div>
                <div><p class="text-gray-400">% Gordura</p><p class="font-semibold text-white"><?php echo e($lastMeasurement->body_fat ? $lastMeasurement->body_fat . '%' : '-'); ?></p></div>
                <div><p class="text-gray-400">Massa Musc.</p><p class="font-semibold text-white"><?php echo e($lastMeasurement->muscle_mass ? $lastMeasurement->muscle_mass . ' kg' : '-'); ?></p></div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-2 text-sm">
                <div><span class="text-gray-400">Peito:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->chest ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Braço Esq:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->left_arm ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Braço Dir:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->right_arm ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Cintura:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->waist ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Abdômen:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->abdomen ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Quadril:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->hips ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Coxa Esq:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->left_thigh ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Coxa Dir:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->right_thigh ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Pant. Esq:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->left_calf ?? '-'); ?></span></div>
                <div><span class="text-gray-400">Pant. Dir:</span> <span class="font-medium text-white"><?php echo e($lastMeasurement->right_calf ?? '-'); ?></span></div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm bg-gray-900/60 p-4 rounded-lg border border-gray-700">
                <div><span class="font-bold text-gray-200">Lesões:</span> <span class="text-gray-300"><?php echo e($lastMeasurement->injuries ?? 'Nenhuma'); ?></span></div>
                <div><span class="font-bold text-gray-200">Dores:</span> <span class="text-gray-300"><?php echo e($lastMeasurement->pain_points ?? 'Nenhuma'); ?></span></div>
                <div><span class="font-bold text-gray-200">Cirurgias:</span> <span class="text-gray-300"><?php echo e($lastMeasurement->surgeries ?? 'Nenhuma'); ?></span></div>
                <div><span class="font-bold text-gray-200">Medicamentos:</span> <span class="text-gray-300"><?php echo e($lastMeasurement->medications ?? 'Nenhum'); ?></span></div>
            </div>
        </div>
        ...
        <div>
            ...
            <p class="text-sm text-gray-300 italic bg-gray-900/60 p-2 rounded-lg border border-gray-700"><?php echo e($lastMeasurement->notes ?? 'Sem observações'); ?></p>
        </div>
    </div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fitmanager\resources\views/student/dashboard.blade.php ENDPATH**/ ?>